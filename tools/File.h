...
namespace rem
{
	...
	public:
		...
		File_only_path();
		void set_button_save_or_open(int status);

		public slots:

			void get_tree_view_selected_file_name(const QModelIndex &index);
	};
}
