...
"    border-image: url(:/picture_notepad/scrollbar/picture_n"
                        "otepad/scrollbar_style/line_horizental.png); \n"
"    border: 0px; \n"
"    height: 9px;\n"
"}\n"
...
"{\n"
"    border-image: none;\n"
"    image: url(:/picture_notepad/treeview/picture_notepad/treeview_style/down_branch.png);\n"
"}\n"
...
"QTreeView::branch:closed:has-chil"
                        "dren:has-siblings:pressed\n"
"{\n"
"    border-image: none;\n"
"    image: url(:/picture_notepad/treeview/picture_notepad/treeview_style/down_branch.png);\n"
"}\n"
...
"{\n"
"    border-image: none;\n"
"    image: url(:/picture_notepad/treeview/picture_notepad/treeview_style/up_branch.png);\n"
"    width:12px;\n"
"    height:8px;\n"
"}\n"
...
"}"));
        ...
        pushButton_open->setStyleSheet(QLatin1String("border-image: url(:/picture_notepad/dialogicon/picture_notepad/icon/dialog_filedialog_open_normal.png);\n"
"border-image: url(:/picture_notepad/dialogicon/picture_notepad/icon/dialog_filedialog_open_pressed.png);"));
        pushButton_exit = new QPushButton(FileClass);
        pushButton_exit->setObjectName(QStringLiteral("pushButton_exit"));
        pushButton_exit->setGeometry(QRect(352, 510, 150, 60));
        pushButton_exit->setStyleSheet(QLatin1String("border-image: url(:/picture_notepad/dialogicon/picture_notepad/icon/dialog_filedialog_exit_normal.png);\n"
"border-image: url(:/picture_notepad/dialogicon/picture_notepad/icon/dialog_filedialog_exit_pressed.png);"));
