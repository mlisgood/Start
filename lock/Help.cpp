...
namespace rem
{
	...
	Help::Help(QWidget *parent) : QDialog(parent)
	{
		...
		//加载按钮样式
		ui.pushButton_close_dialog->setStyleSheet("QPushButton{border-image: url(:/icon/mainicon/picture_lock/icon/dialog_main_exit_normal.png);}""QPushButton:hover{border-image: url(:/icon/mainicon/picture_lock/icon/dialog_main_exit_pressed.png);}");
