...
"}"));
        ...
        pushButton_open->setStyleSheet(QLatin1String("border-image: url(:/picture_lock/dialogicon/picture_lock/icon/dialog_filedialog_open_normal.png);\n"
"border-image: url(:/picture_lock/dialogicon/picture_lock/icon/dialog_filedialog_open_pressed.png);"));
        pushButton_exit = new QPushButton(FileClass);
        pushButton_exit->setObjectName(QStringLiteral("pushButton_exit"));
        pushButton_exit->setGeometry(QRect(352, 510, 150, 60));
        pushButton_exit->setStyleSheet(QLatin1String("border-image: url(:/picture_lock/dialogicon/picture_lock/icon/dialog_filedialog_exit_normal.png);\n"
"border-image: url(:/picture_lock/dialogicon/picture_lock/icon/dialog_filedialog_exit_pressed.png);"));
