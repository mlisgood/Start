/********************************************************************************
** Form generated from reading UI file 'LockNormalDoubleKey.ui'
**
...
#ifndef UI_LOCKNORMALDOUBLEKEY_H
#define UI_LOCKNORMALDOUBLEKEY_H
...
class Ui_LockNormalDoubleKeyClass
{
public:
    ...
    void setupUi(QDialog *LockNormalDoubleKeyClass)
    {
        if (LockNormalDoubleKeyClass->objectName().isEmpty())
            LockNormalDoubleKeyClass->setObjectName(QStringLiteral("LockNormalDoubleKeyClass"));
        LockNormalDoubleKeyClass->resize(400, 600);
        LockNormalDoubleKeyClass->setContextMenuPolicy(Qt::NoContextMenu);
        QIcon icon;
        icon.addFile(QStringLiteral(":/icon/mainicon/picture_lock/icon/icon_main_mainwindow.png"), QSize(), QIcon::Normal, QIcon::Off);
        LockNormalDoubleKeyClass->setWindowIcon(icon);
        LockNormalDoubleKeyClass->setWindowOpacity(5);
        label_chara_1 = new QLabel(LockNormalDoubleKeyClass);
        label_chara_1->setObjectName(QStringLiteral("label_chara_1"));
        label_chara_1->setGeometry(QRect(0, 0, 400, 400));
        label_chara_2 = new QLabel(LockNormalDoubleKeyClass);
        label_chara_2->setObjectName(QStringLiteral("label_chara_2"));
        label_chara_2->setGeometry(QRect(0, 0, 400, 400));
        label_margin = new QLabel(LockNormalDoubleKeyClass);
        ...
        pushButton_1 = new QPushButton(LockNormalDoubleKeyClass);
...
"border-image: url(:/icon/mainicon/picture_lock/icon/lock_button_pressed_1.png);"));
        pushButton_2 = new QPushButton(LockNormalDoubleKeyClass);
...
"border-image: url(:/icon/mainicon/picture_lock/icon/lock_button_pressed_2.png);"));
        pushButton_3 = new QPushButton(LockNormalDoubleKeyClass);
...
"border-image: url(:/icon/mainicon/picture_lock/icon/lock_button_pressed_3.png);"));
        label_background = new QLabel(LockNormalDoubleKeyClass);
        ...
        label_background->setPixmap(QPixmap(QString::fromUtf8("picture_lock/lock_normal_double_background/background_1.png")));
        lineEdit_2 = new QLineEdit(LockNormalDoubleKeyClass);
...
"}"));
        ...
        lineEdit_1 = new QLineEdit(LockNormalDoubleKeyClass);
...
"}"));
        ...
        lineEdit = new QLineEdit(LockNormalDoubleKeyClass);
...
"}"));
        ...
        checkBox = new QCheckBox(LockNormalDoubleKeyClass);
...
"QCheckBox::indicator:enabled:checked:pressed {image: url(:/picture_lock/checkbox/picture_lock/checkbox_style/checkbox_on.png);}"));
        comboBox_1 = new QComboBox(LockNormalDoubleKeyClass);
...
"}"));
        ...
        comboBox_2 = new QComboBox(LockNormalDoubleKeyClass);
        comboBox_2->setObjectName(QStringLiteral("comboBox_2"));
        comboBox_2->setGeometry(QRect(138, 532, 128, 20));
...
"}"));
        ...
        pushButton_4 = new QPushButton(LockNormalDoubleKeyClass);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(270, 527, 92, 30));
        pushButton_4->setStyleSheet(QLatin1String("border-image: url(:/icon/mainicon/picture_lock/icon/lock_button_normal_15.png);\n"
"border-image: url(:/icon/mainicon/picture_lock/icon/lock_button_pressed_15.png);"));
        ...
        retranslateUi(LockNormalDoubleKeyClass);

        comboBox_2->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(LockNormalDoubleKeyClass);
    } // setupUi

    void retranslateUi(QDialog *LockNormalDoubleKeyClass)
    {
        LockNormalDoubleKeyClass->setWindowTitle(QApplication::translate("LockNormalDoubleKeyClass", "\351\235\236\345\257\271\347\247\260\345\212\240\345\257\206", Q_NULLPTR));
        ...
        comboBox_1->insertItems(0, QStringList()
         << QApplication::translate("LockNormalDoubleKeyClass", "RSA", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "ECC", Q_NULLPTR)
        );
        comboBox_2->clear();
        comboBox_2->insertItems(0, QStringList()
         << QApplication::translate("LockNormalDoubleKeyClass", "1024", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "1536", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "2048", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "2560", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "3072", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "3584", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "4096", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "4608", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "5120", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "5632", Q_NULLPTR)
         << QApplication::translate("LockNormalDoubleKeyClass", "6144", Q_NULLPTR)
        );
...
namespace Ui {
    class LockNormalDoubleKeyClass: public Ui_LockNormalDoubleKeyClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_LOCKNORMALDOUBLEKEY_H
