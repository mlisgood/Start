...
public:
    ...
    void setupUi(QDialog *HelpClass)
    {
        ...
        pushButton_close_dialog->setStyleSheet(QLatin1String("border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_normal.png);\n"
