...
namespace rem
{
	...
	File::File(QWidget *parent) : QDialog(parent)
	{
		...
		//加载按钮样式
		ui.pushButton_exit->setStyleSheet("QPushButton{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_normal.png);}""QPushButton:hover{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_pressed.png);}");
	...
	void File::set_button_save_or_open(int status)//设置按钮
	{
		if (status == 0)
		{
			ui.pushButton_open->setStyleSheet("QPushButton{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_open_normal.png);}""QPushButton:hover{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_open_pressed.png);}");
		}
		else if (status == 1)
		{
			ui.pushButton_open->setStyleSheet("QPushButton{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_save_normal.png);}""QPushButton:hover{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_save_pressed.png);}");
		}
		else
		{
