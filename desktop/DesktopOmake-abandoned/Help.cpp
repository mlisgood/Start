...
namespace rem
{
	...
	Help::Help(QWidget *parent) : QDialog(parent)
	{
		...
		//加载按钮样式
		ui.pushButton_close_dialog->setStyleSheet("QPushButton{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_normal.png);}""QPushButton:hover{border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_pressed.png);}");
