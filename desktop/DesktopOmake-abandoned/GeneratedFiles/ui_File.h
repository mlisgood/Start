...
public:
    ...
    void setupUi(QDialog *FileClass)
    {
        ...
        pushButton_close_window->setStyleSheet(QStringLiteral("border-image: url(:/picture_desktop/icon/picture_desktop/icon/window_close.png);"));
...
"    border-image: url(:/picture_desktop/scrollbar/picture_d"
                        "esktop/scrollbar_style/line_horizental.png); \n"
"    border: 0px; \n"
"    height: 9px;\n"
"}\n"
...
"}"));
        ...
        pushButton_open->setStyleSheet(QLatin1String("border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_open_normal.png);\n"
"border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_open_pressed.png);"));
        pushButton_exit = new QPushButton(FileClass);
        pushButton_exit->setObjectName(QStringLiteral("pushButton_exit"));
        pushButton_exit->setGeometry(QRect(352, 510, 150, 60));
        pushButton_exit->setStyleSheet(QLatin1String("border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_normal.png);\n"
"border-image: url(:/picture_desktop/dialogicon/picture_desktop/icon/dialog_filedialog_exit_pressed.png);"));
